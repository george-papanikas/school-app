		...
		insertBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String firstnameMessage = (teacherErrors.get("firstname") != null) ?
							"Firstname: " + teacherErrors.get("firstname") : "";

					String lastnameMessage = (teacherErrors.get("lastname") != null) ?
							"Lastname: " + teacherErrors.get("lastname") : "";

					if (!teacherErrors.isEmpty()) {
						JOptionPane.showMessageDialog(null, firstnameMessage + " " + lastnameMessage,
